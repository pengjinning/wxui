...
static WXUIApis *sharedInstance = nil;

@implementation WXUIApis

+ (WXUIApis *)sharedInstance {
    
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        sharedInstance = [[WXUIApis alloc] init];
    });
...
//    https://blog.csdn.net/u011096206/article/details/50606778
    [self initUI];
    //
    WXChatViewController *chatViewController = [[WXChatViewController alloc] init];
    chatViewController.navigationItem.backBarButtonItem.title = @"";
    [chatViewController initWithWorkgroupId:workgroupId withTitle:title withPush:YES];
...
+ (void)visitorPresentChat:(UINavigationController *)navigationController
    ...
    WXChatViewController *chatViewController = [[WXChatViewController alloc] init];
    [chatViewController initWithWorkgroupId:workgroupId withTitle:title withPush:NO];
    //
