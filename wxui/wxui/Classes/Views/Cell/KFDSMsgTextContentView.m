...
@interface KFDSMsgTextContentView()<M80AttributedLabelDelegate>

@end

@implementation KFDSMsgTextContentView
...
//    [_textLabel wxui_setText:text];
    
    // TODO: 放在wxui_setText函数中表情无法显示，暂时复制代码到此处，bug未知？？
    [_textLabel setText:@""];
